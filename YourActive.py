...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.pc_work_time_text = customtkinter.CTkLabel(master= self, text=f"PC WORKING TIME: {pc_work_time}", fg_color="transparent", justify = "center",width = 600,height=50,font=font)
        self.pc_work_time_text.place(relx=0.5, rely=0.2, anchor= "center")

        self.pc_boot_time_text = customtkinter.CTkLabel(master= self, text=f"COMPUTER WAS STARTED IN: {wakeup_time}", fg_color="transparent", justify = "center",width = 600,height=50,font=font)
        ...
        self.checkbox= customtkinter.CTkCheckBox(self, text= 'turn on the time display',font=font,fg_color = 'white',border_color = 'white',corner_radius = 0,hover = False,variable=self.checkbox_var,command=self.toggle_time_window)
    ...
    def update(self):
        ...
        self.pc_work_time_text.configure(text=f"PC WORKING TIME: {formatted_time}")
        self.pc_current_time_text.configure(text=f"TIME SPENT ON THE PC: {self.time_in_pc}")
